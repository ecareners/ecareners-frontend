              ...
              {item.lectures.map((lecture, idx) => <Fragment key={idx}>
                  <div className="d-sm-flex justify-content-sm-between align-items-center" key={idx}>
                    <div className="d-flex">
                      {lecture.isPremium ? <Button variant="light" className="btn btn-round mb-0 flex-shrink-0 flex-centered">
                          <BsLockFill size={16} />
                        </Button> : <Button variant="danger-soft" className="btn btn-round mb-0 flex-centered">
                          <FaPlay size={16} />
                        </Button>}
