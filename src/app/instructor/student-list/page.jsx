...
const StudentListPage = () => {
  ...
  if (userRole === undefined) {
    return <div className="container py-5"><div className="alert alert-info">Loading...</div></div>;
  }
  if (userRole === 'mahasiswa') {
    return <div className="container py-5"><div className="alert alert-danger">Access Denied: Mahasiswa cannot access Assessment.</div></div>;
  }
  return <>
