      ...
      <Container>
        <Row className="d-lg-flex justify-content-lg-between g-4 g-md-5">
          <Col lg={7} className="position-relative z-index-1 mb-2">
            ...
            <Button variant="blue" size="lg" className="mb-0">
              Apply Now
            </Button>
          </Col>
          <Col lg={5} xxl={3} className="position-relative">
            ...
            'mb-3': topStudents.length - 1 != idx
                ...
                <div className="avatar avatar-xl">
                  <img className="avatar-img rounded-circle" src={student.avatar} alt="avatar" />
                  <div className="position-absolute bottom-0 end-0">
                    <img src={medalBadge} className="position-relative" alt="medal" />
                    <span className="fw-bold text-dark smaller position-absolute top-50 start-50 translate-middle">
                      {student.rank}
                      <sup>st</sup>
                    </span>
                  </div>
        ...
        <Row className="g-lg-5 align-items-center mt-5 mt-lg-0">
          <Col lg={6} xl={5}>
            <ul className="list-inline vstack gap-4 flex-wrap mb-4">
              <li className="list-inline-item border-bottom me-0">
                <div className="d-sm-flex justify-content-between align-items-center mb-3">
                  <div className="d-sm-flex align-items-center">
                    <img height={70} width={73} src={medalImg} className="me-3 mb-2 mb-sm-0 h-70px" alt="medal" />
              ...
              <li className="list-inline-item">
                <div className="d-sm-flex justify-content-between align-items-center mb-3">
                  <div className="d-sm-flex align-items-center">
                    <img height={70} width={73} src={medalImg} className="me-3 mb-2 mb-sm-0 h-70px" alt="medal-image" />
          ...
          <Col lg={6} xl={7} className="position-relative mt-5 mt-lg-0">
            ...
            <img src={backgroundImg} className="rounded-3" alt="bg-image" />
          </Col>
        </Row>
      </Container>
    </section>;
