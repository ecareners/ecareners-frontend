      ...
      <Container>
        <Row>
          ...
          <Col lg={5} className="mb-4 mb-lg-0">
            ...
            <a href="#" className="btn btn-lg btn-primary-soft mb-4">
              Get Inquiry
            </a>
            <Row className="g-4">
              ...
              return <Col md={6} key={idx}>
                    <div className="d-flex align-items-center">
                      <div className={`icon-lg fs-4 text-${item.variant} bg-${item.variant} bg-opacity-10 rounded flex-shrink-0`}>
          ...
          <Col lg={7}>
            <div className="position-relative">
              ...
              <img src={backgroundImg4} className="rounded-3" alt="bg-image" />
            </div>
          </Col>
        </Row>
      </Container>
