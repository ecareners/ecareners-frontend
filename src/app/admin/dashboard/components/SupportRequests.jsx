      ...
      <div className="d-flex justify-content-between position-relative">
        <div className="d-sm-flex">
          <div className="avatar avatar-md flex-shrink-0">
            {image ? <img className="avatar-img rounded-circle" src={image} alt="avatar" /> : <div className={`avatar-img rounded-circle bg-${randomItem} bg-opacity-10`}>
  ...
  return <Col xxl={4}>
      <Card className="shadow h-100">
        ...
        <CardBody className="p-4">
          {supportRequestsData.map((item, idx) => <Fragment key={idx}>
