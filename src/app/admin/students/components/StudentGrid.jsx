        ...
        <CardFooter className="bg-transparent border-top">
          <div className="d-sm-flex justify-content-between align-items-center">
            ...
            <div className="text-end text-primary-hover">
              <Link to="#" className="btn btn-link text-body p-0 mb-0 me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Message" aria-label="Message">
                <BsEnvelopeFill />
              </Link>
              <Link to="#" className="btn btn-link text-body p-0 mb-0" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Block" aria-label="Block">
