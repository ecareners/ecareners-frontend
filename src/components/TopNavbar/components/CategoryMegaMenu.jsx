        ...
        <Row className="p-4">
          <Col xl={6} xxl={4} className="mb-4 mb-xl-0">
            ...
            <ul className="list-unstyled">
              {CategoryMegaMenuData.getStarted.map((item, idx) => <li key={idx}>
          ...
          <Col xl={6} xxl={4} className="mb-4 mb-xl-0">
            ...
            {CategoryMegaMenuData.degree.map((degree, idx) => <div className="d-flex mb-4 position-relative" key={idx}>
                {degree.image && <img src={degree.image} className="icon-md" alt="uniLogo" />}
                <div className="ms-3">
          ...
          <Col xl={6} xxl={4}>
            ...
            return <div className="d-flex mb-4 position-relative" key={idx}>
                  {Icon && <h2 className="mb-0">
                      <Icon className={`${certificate.iconClass}`} />
                    </h2>}
                  <div className="ms-2">
                    <a className="stretched-link h6 mb-0" href="#">
                      {certificate.label}
